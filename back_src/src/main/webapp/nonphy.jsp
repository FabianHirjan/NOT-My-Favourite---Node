...
<%
    request.setAttribute("activePage", "nonPhysicalProducts");
%>
...
<center>
    <div class="article" id="search">
        <form action="nonphysical-servlet" method="post">
            <div>
...
<div class="article-container">
    <%
        List<Article> nonPhysicalArticles = (List<Article>) request.getAttribute("nonPhysicalArticles");
        if (nonPhysicalArticles != null && !nonPhysicalArticles.isEmpty()) {
    ...
    %>
    <p>No non-physical articles found.</p>
    <%
        }
    %>
</div>
